...
public class Menu : MonoBehaviourPunCallbacks
{
    ...
    public void OnCreateRoomButton(TMP_InputField roomNameInput)
    {
        ...
        roomText.text = roomNameInput.text;
    }
    ...
    public override void OnJoinedRoom()
    {
        ...
        //tell everyone to update the lobby screen
    ...
    public override void OnPlayerLeftRoom(Player otherPlayer)
    {
        ...
        //thats because OnJoinedRoom is only called for the client who just joined the room
    ...
    {
        NetworkManager.instance.photonView.RPC("ChangeScene", RpcTarget.All, "Game 1");
    }
}
